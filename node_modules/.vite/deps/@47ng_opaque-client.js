// node_modules/@47ng/opaque-client/opaque-client.js
var wasm;
...
var Login = class _Login {
  static __wrap(ptr) {
    const obj = Object.create(_Login.prototype);
    obj.ptr = ptr;
    return obj;
  }
  __destroy_into_raw() {
...
var Registration = class _Registration {
  static __wrap(ptr) {
    const obj = Object.create(_Registration.prototype);
    obj.ptr = ptr;
    return obj;
  }
  __destroy_into_raw() {
  ...
  */
  constructor() {
    ...
    return _Registration.__wrap(ret);
  }
  /**
  * @param {string} password
  * @returns {Uint8Array}
...
async function init(input) {
  if (typeof input === "undefined") {
    input = new URL("opaque-client_bg.wasm", import.meta.url);
  }
  const imports = getImports();
...
var opaque_client_default = init;
export {
  Login,
  Registration,
...
//# sourceMappingURL=@47ng_opaque-client.js.map
